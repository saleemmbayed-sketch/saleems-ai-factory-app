//! Saleem's AI Factory — Tauri 2 backend entrypoint.
//!
...
//
//     tauri signer generate -w ~/.config/saleems-ai-factory-app/updater.key
//
...
// thing standing between a compromised saleems-ai-factory.app and a
// malicious binary push.
//
// Real minisign public key. The matching private key lives at
// `~/.config/saleems-ai-factory-app/updater.key` (chmod 600,
    ...
    let _ = tracing_subscriber::fmt()
        .with_env_filter(
            tracing_subscriber::EnvFilter::try_from_default_env()
                .unwrap_or_else(|_| tracing_subscriber::EnvFilter::new("warn,saleems_ai_factory_app=info")),
        )
        .try_init();
...
const MENU_EVENT_ABOUT: &str = "saleems-ai-factory-app/menu/about";
const MENU_EVENT_SETTINGS: &str = "saleems-ai-factory-app/menu/settings";
