...
pub enum CatalogSource {
    ...
    Bundled,
    /// A clone the app provisioned and owns (default `~/.saleems-ai-factory`). The
...
pub struct CatalogDetection {
    ...
    /// "Find Saleem's AI Factory" button), vs the cheap `~/.saleems-ai-factory`-only check.
    pub scanned: bool,
