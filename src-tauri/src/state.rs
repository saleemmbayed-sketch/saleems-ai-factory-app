...
pub struct AppState {
    ...
    /// `~/Library/Application Support/com.saleem.saleems-ai-factory-app/` directory. The
...
/// `~/Library/Application Support/com.saleem.saleems-ai-factory-app/`. The corpus, install
...
fn resolve_app_data_dir() -> Result<PathBuf, AppError> {
    ...
    base.push("com.saleem.saleems-ai-factory-app");
    Ok(base)
}
